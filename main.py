...
model=pickle.load(open('model_pkl_svm','rb')) #entiment_analysis.pickle
...
def main():
    ...
    if selected=='Home':
        ...
        with col3:
                ...
                st.write('\t')
                st.title('Linkdin ')
                st.markdown(" [Marouane Fahmi](https://www.linkedin.com/in/marouane-fahmi-a1414415b/)")
        st.text("")
        st.write('Check Github notebook : [click here](https://www.kaggle.com/code/ikrambelgas/sentiment-analysis/notebook)')
